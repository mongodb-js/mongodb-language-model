...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c124 = function(date) { return {"$date": date }; },
      peg$c125 = function(date) { return date; },
      peg$c126 = "$undefined",
      peg$c127 = peg$literalExpectation("$undefined", false),
      peg$c128 = function() { return {"$undefined": true }; },
      peg$c129 = "$ref",
      peg$c130 = peg$literalExpectation("$ref", false),
      peg$c131 = function(string) { return string; },
      peg$c132 = "$id",
      peg$c133 = peg$literalExpectation("$id", false),
      peg$c134 = function(ref, value) {return value; },
      peg$c135 = "$db",
      peg$c136 = peg$literalExpectation("$db", false),
      peg$c137 = function(ref, id, string) {return string; },
      peg$c138 = function(ref, id, db) {
              var result = {"$ref": ref, "$id": id};
              if (db !== null) result["$db"] = db;
            	return result;
            },
      peg$c139 = function(members) { return members; },
      peg$c140 = "$regex",
      peg$c141 = peg$literalExpectation("$regex", false),
      peg$c142 = "$options",
      peg$c143 = peg$literalExpectation("$options", false),
      peg$c144 = /^[gims]/,
      peg$c145 = peg$classExpectation(["g", "i", "m", "s"], false, false),
      peg$c146 = function(regex, options) {return options.join(''); },
      peg$c147 = function(regex, options) { return {"$regex": regex, "$options": options ? options : ""}; },
      peg$c148 = "$binary",
      peg$c149 = peg$literalExpectation("$binary", false),
      peg$c150 = function(binary, type) {return type; },
      peg$c151 = function(binary, type) { return {"$binary": binary, "$type": type}; },
      peg$c152 = "$timestamp",
      peg$c153 = peg$literalExpectation("$timestamp", false),
      peg$c154 = "t",
      peg$c155 = peg$literalExpectation("t", false),
      peg$c156 = "i",
      peg$c157 = peg$literalExpectation("i", false),
      peg$c158 = function(t, i) { return {"t": t, "i": i}; },
      peg$c159 = function(object) { return {"$timestamp": object }; },
      peg$c160 = function(head, m) { return m; },
      ...
      peg$c162 = function(members) { return members !== null ? members : {}; },
      peg$c163 = function(name, value) {
            return { name: name, value: value };
          },
      peg$c164 = peg$otherExpectation("number"),
      peg$c165 = function() { return parseFloat(text()); },
      peg$c166 = ".",
      ...
      peg$c176 = "0",
      peg$c177 = peg$literalExpectation("0", false),
      ...
      peg$c199 = "u",
      peg$c200 = peg$literalExpectation("u", false),
      peg$c201 = function(digits) { return String.fromCharCode(parseInt(digits, 16)); },
      peg$c202 = function(sequence) { return sequence; },
      peg$c203 = /^[^\0-\x1F"\\]/,
      peg$c204 = peg$classExpectation([["\0", "\x1F"], "\"", "\\"], true, false),
      peg$c205 = /^[0-9]/,
      peg$c206 = peg$classExpectation([["0", "9"]], false, false),
      peg$c207 = /^[0-9a-f]/i,
      peg$c208 = peg$classExpectation([["0", "9"], ["a", "f"]], false, true),
      peg$c209 = "--",
      peg$c210 = peg$literalExpectation("--", false),
      peg$c211 = "W",
      peg$c212 = peg$literalExpectation("W", false),
      peg$c213 = "---",
      peg$c214 = peg$literalExpectation("---", false),
      peg$c215 = "Z",
      peg$c216 = peg$literalExpectation("Z", false),
      peg$c217 = "T",
      peg$c218 = peg$literalExpectation("T", false),
      peg$c219 = "S",
      peg$c220 = peg$literalExpectation("S", false),
      peg$c221 = "M",
      peg$c222 = peg$literalExpectation("M", false),
      peg$c223 = "H",
      peg$c224 = peg$literalExpectation("H", false),
      peg$c225 = "D",
      peg$c226 = peg$literalExpectation("D", false),
      peg$c227 = "Y",
      peg$c228 = peg$literalExpectation("Y", false),
      peg$c229 = "P",
      peg$c230 = peg$literalExpectation("P", false),
